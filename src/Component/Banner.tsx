            ...
            <header className='grid justify-center md:flex md:justify-between md:items-center container mx-auto'>
                <div>
                    ...
                    <div className='my-6 text-center md:text-left'>
                         <button className='text-white text-[14px] font-medium bg-linear-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] rounded-xl py-1.5 px-5 text-[14px] '>Explore Technologies</button>
